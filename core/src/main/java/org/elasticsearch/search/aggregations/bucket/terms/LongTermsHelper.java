...
public class LongTermsHelper {
    ...
    public static LongTerms fromXContent(final String name, final Map<String, Object> map) {
        ...
        for (Object bucketObj : bucketObjs) {
            ...
            buckets.add(LongTermsBucketHelper.fromXContent(bucket));
        }
