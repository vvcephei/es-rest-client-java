...
public class GeoDistanceBucketHelper {
    ...
    public static InternalGeoDistance.Bucket fromXContent(final String name, final Map<String, Object> map, final AggregationsManifest manifest) {
        ...
        return new InternalGeoDistance.Bucket(key, from, to, docCount, aggregations, ValueFormatter.RAW);
    }
}
