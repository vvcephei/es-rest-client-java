...
public class DateRangeBucketHelper {
    ...
    public static InternalDateRange.Bucket fromXContent(final String name, final Map<String, Object> map, final AggregationsManifest manifest) {
        ...
        return new InternalDateRange.Bucket(key, from, to, docCount, aggregations, ValueFormatter.RAW);
    }
}
