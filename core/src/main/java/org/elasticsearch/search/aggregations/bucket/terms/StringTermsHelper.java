...
public class StringTermsHelper {
    ...
    public static StringTerms fromXContent(final String name, final Map<String, Object> map) {
        ...
        for (Object bucketObj : bucketObjs) {
            ...
            buckets.add(StringTermsBucketHelper.fromXContent(bucket));
        }
