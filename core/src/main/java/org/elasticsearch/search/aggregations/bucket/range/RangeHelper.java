...
public class RangeHelper {
    ...
    private static InternalAggregation internalAnonRange(final String name, final List<Object> list, final AggregationsManifest manifest) {
    ...
    private static InternalAggregation internalKeyedRange(final String name, final Map<String, Object> map, final AggregationsManifest manifest) {
        final ImmutableList.Builder<InternalRange.Bucket> buckets = ImmutableList.builder();
